...
w = tk.Tk()
w.title("Eyeball Cursor Moment")

w.geometry("450x250")
w.configure(background='snow')

takeImg = tk.Button(w, text="Start",command=run,fg="white"  ,bg="blue2"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=90)
